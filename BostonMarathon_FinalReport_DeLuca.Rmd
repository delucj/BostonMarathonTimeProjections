...
$$\widehat{Y}=\left( \frac{(\widehat{Y_{lm}}+\widehat{A_{rf}})+(\widehat{Y_{lm}}*\widehat{R_{rf}})}{2} \right)$$
Where:
$$\widehat{Y} = Final\ Race\ Time\ Prediction$$
$$\widehat{Y_{lm}} = Linear\ Regression\ Model\ Prediction\ of\ Final\ Race\ Time$$
$$\widehat{A_{rf}} = Random\ Forest\ Model\ Prediction\ of\ Addition\ Residual\ to\ Linear\ Model\ Predicted\ Time$$
$$\widehat{R_{rf}} = Random\ Forest\ Model\ Prediction\ of\ Final\ Time\ Divided\ By\ Linear\ Model\ Predicted\ Time$$
